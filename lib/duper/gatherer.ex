defmodule Duper.Gatherer do
  ...
  def init(worker_count) do
    # it sends a message to itself to start all worked based on given worker_count state
    # this should be handled on a event message (therefore callback) so that
    # server will have time to initialize itself and be ready to init workers
